...
class RainbowChart extends React.Component {
    render() {
        ...
        return (
            <RadialBarChart width={500} height={300} cx={150} cy={150} innerRadius={20} outerRadius={140} barSize={10}
                            data={data}>
                <RadialBar minAngle={15} maxAngle={180} label background clockWise={true} dataKey='value'/>
