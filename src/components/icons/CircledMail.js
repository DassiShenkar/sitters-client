...
class CircledMail extends React.Component {

    render() {
        return (
            <svg id={this.props.id} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path
